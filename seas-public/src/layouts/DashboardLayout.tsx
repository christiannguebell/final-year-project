  ...
  return (
    <div className="bg-background text-on-surface min-h-screen flex flex-col">
      ...
      <nav className="fixed top-0 w-full z-50 bg-surface/80 backdrop-blur-xl h-16 flex justify-between items-center px-8 max-w-[1920px] mx-auto glass-nav">
        <div className="text-lg font-bold text-primary tracking-tighter font-headline">SEAS Platform</div>
        <div className="hidden md:flex space-x-8 items-center font-headline font-semibold tracking-tight">
          <Link to="#" className="text-on-surface-variant hover:text-primary-container transition-opacity duration-300">Admissions</Link>
          <Link to="#" className="text-on-surface-variant hover:text-primary-container transition-opacity duration-300">Programs</Link>
          <Link to="#" className="text-on-surface-variant hover:text-primary-container transition-opacity duration-300">Resources</Link>
          <Link to="#" className="text-on-surface-variant hover:text-primary-container transition-opacity duration-300">Help</Link>
        </div>
        <div className="flex items-center space-x-6">
          ...
          <span className="material-symbols-outlined text-on-surface-variant cursor-pointer hover:opacity-80 transition-opacity">settings</span>
      ...
      <div className="flex flex-1 pt-16">
        ...
        <aside className="h-[calc(100vh-64px)] w-64 bg-surface-container-low flex flex-col p-4 space-y-2 sticky top-16 border-r border-outline-variant/15">
          ...
          <div className="mt-auto pt-4 space-y-1">
            ...
            <button className="w-full flex items-center space-x-3 p-3 text-error hover:bg-error-container/50 transition-all duration-200 ease-in-out rounded-lg">
